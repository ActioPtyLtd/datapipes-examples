...
![alt text](http://yuml.me/diagram/scruffy/class/edit/[note: DOMs are immutable objects that flow through Pipes and Tasks {bg:cornsilk}], , [DOM]++-successful%2Ffailed>[DataSet], [DOM]++-events *>[Events], [DOM]++-child *>[DOM])
